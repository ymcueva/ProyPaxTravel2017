					...
					<div class="row">
						<div class="col-sm-12">
							...
							<form id="frmCotizacion" name="frmCotizacion" role="form" class="form-horizontal" method="post">
								...
								<div class="form-group">
									<div class="col-sm-1" style="text-align:left; font-weight:bold;width: 140px;">Tipo Cotizaci&oacute;n:</div>
													...
													<div class="form-group">
														...
														<div class="form-group">
															...
															<div class="col-sm-12">
																...
																<fieldset>
																	<legend style="margin:7px; font-size:15px;"> Servicios Adicionales </legend>
